  ...
  if (error) {
    return (
      <div className="min-h-[100dvh] flex flex-col items-center justify-center p-4">
        ...
        <h2 className="text-2xl font-serif text-destructive mb-2">
    ...
    <div className="min-h-[100dvh] max-w-7xl mx-auto p-4 md:p-6 lg:p-8 space-y-6 pb-20">
      ...
      <div id="kundali-report">
        ...
        <div className="hidden print-only mb-6 border-b pb-4">
          <h1 className="text-2xl font-serif" style={{ color: "#ff4d00" }}>
            {birthDetails.name}'s Janam Kundali
          </h1>
          <p className="text-sm text-gray-600 mt-1">
            Born: {birthDetails.date} at {birthDetails.time} • Place:{" "}
            {birthDetails.place}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <Card className="bg-card/50 backdrop-blur border-primary/20">
              <CardHeader className="pb-2">
                <CardTitle className="text-lg sm:text-xl font-serif text-primary">
                  Birth Summary
                </CardTitle>
              </CardHeader>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-3 sm:gap-4">
                  {[
                    ...
                    {
                      label: "Nakshatra",
                      value: `${nakshatra.name} (Pada ${nakshatra.pada})`,
                    },
                  ].map((item) => (
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow className="border-border/50 hover:bg-transparent">
                        <TableHead className="text-primary text-xs sm:text-sm">
                          Planet
                        </TableHead>
                        <TableHead className="text-primary text-xs sm:text-sm">
                          Sign
                        ...
                        <TableHead className="text-primary text-xs sm:text-sm hidden sm:table-cell">
                          Nakshatra
                        </TableHead>
                      </TableRow>
                    </TableHeader>
                          ...
                          <TableCell className="font-medium py-2">
                            <div className="flex items-center gap-1.5">
                              ...
                              {planet.isRetrograde && (
                                <Badge
                                  variant="outline"
                                  className="text-[9px] h-3.5 px-1 border-primary/50 text-primary/80"
                                >
                                  Rx
                                </Badge>
                              )}
                ...
                {presentYogas.length > 0 ? (
                  <div className="space-y-3">
                    {presentYogas.map((yoga, i) => (
                      <div
                        key={i}
                        className="p-3 sm:p-4 rounded-lg bg-black/20 border border-primary/10"
                      >
                        <h4 className="font-serif text-base sm:text-lg text-primary mb-1">
                          {yoga.name}
                        </h4>
